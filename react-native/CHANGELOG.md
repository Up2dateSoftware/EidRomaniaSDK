...
- Bumped `com.up2date.eidromania:eidromania-android-sdk` from `1.0.7`
  to `1.0.9` (latest available on Google Artifact Registry as of 2026-06-25).
- README + `QUICK_TEST_GUIDE` snippets refreshed.

No iOS or RN bridge changes vs 1.6.1.
