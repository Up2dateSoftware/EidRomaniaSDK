...
export type LicenseFeature = 'passportReading' | 'idCardReading' | 'ocrScanning' | 'cscaValidation' | 'biometricExtraction' | 'advancedSecurity';
...
export declare enum EIDErrorCode {
