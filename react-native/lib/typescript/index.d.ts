...
import type { PassportResult, IDCardResult, MRZScanResult, OCRScanResult, LicenseInfo, PassportReadOptions, IDCardReadOptions, ReadProgressEvent, ReadCompleteEvent, ReadErrorEvent } from './types';
export * from './types';
/**
...
declare class EIDReader {
     ...
     * ```
     */
    static initialize(license: string): Promise<boolean>;
    /**
     ...
     * ```
     */
    static readPassport(mrzKey: string, options?: PassportReadOptions): Promise<PassportResult>;
    /**
     ...
     * ```
     */
    static readIDCard(can: string, pin: string, options?: IDCardReadOptions): Promise<IDCardResult>;
    /**
     ...
     * ```
     */
    static startMRZScanning(): Promise<MRZScanResult>;
    /**
     ...
     * ```
     */
    static startOCRScanning(): Promise<OCRScanResult>;
    /**
